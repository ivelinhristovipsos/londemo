...
from modules.data_helpers import get_excel_data
from modules.control_helpers import sidebar_main, draw_gauge
from modules.style_helpers import add_header, custom_page_style, global_page_style
from modules.data_helpers import map_meth_icons
        ...
        with dqi_col:
            ...
            draw_gauge(
                ...
                ranges=[
                    ...
                    {"range": [10, max_value * .2], "color": "#FFF4CC"},
                    {"range": [0, max_value * .1], "color": "#DDFFDD"},
