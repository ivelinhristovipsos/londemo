...
with st.spinner("Loading..."):
    ...
    add_header("<div class='header-banner'><img src='https://images1.ipsosinteractive.com/GOHBG/ISR/Admin/Reporting_Demo/images/contact_us_banner.png' width='100%'/>", 2)
    ...
    with st.container(border=True):
        ...
        st.markdown('<p class="mailto-subheader">Reach out by emailing <a href="mailto:"BG-PA-HUB-Management@ipsos.com">BG-PA-HUB-Management@ipsos.com</a> and let\'s give you the data access you need!</p>', unsafe_allow_html=True)
